...
const GetOffer = () => {
    return (
        <div className="relative h-[600px] ">
            <div className="relative w-11/12 m-auto h-3/4 overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-10">
                    ...
                    <button className="btn bg-green-700 text-white">Subscribe</button>
                    </div>
                </div>
            ...
            <div className="absolute flex gap-8 justify-center  w-full bottom-16">
